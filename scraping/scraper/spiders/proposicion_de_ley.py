...
class QuotesSpider(scrapy.Spider):
    ...
    def parse(self, response, **kwargs):
        return [FormRequest(
            url="https://www.congreso.es/proposiciones-de-ley?p_p_id=iniciativas&p_p_lifecycle=2&p_p_state=normal&p_p_mode=view&p_p_resource_id=filtrarListado&p_p_cacheability=cacheLevelPage&_iniciativas_legislatura=14&_iniciativas_cini=122.CINI.&_iniciativas_tipoLlamada=T&_iniciativas_paginaActual=1",
