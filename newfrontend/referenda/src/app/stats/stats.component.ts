...
export class StatsComponent implements OnInit {
  ...
  buildData(laws: Law[]) {
    var psoe = {"label": "PSOE", "id": 1, "value": 0, "color": "#ee1d1d"};
    var pp = {"label": "PP", "id": 2, "value": 0, "color": "#00a3df"};
    var vox = {"label": "VOX", "id": 3, "value": 0, "color": "#81c03b"};
    var podemos = {"label": "Podemos-IU", "id": 4, "value": 0, "color": "#683064"};
    var erc = {"label": "ERC", "id": 5, "value": 0, "color": "#feb832"};
    var ciudadanos = {"label": "Ciudadanos", "id": 6, "value": 0, "color": "#f36b25"};
    var jpc = {"label": "Junts per Catalunya", "id": 7, "value": 0, "color": "#02428b"};
    var pnv = {"label": "PNV", "id": 8, "value": 0, "color": "#409552"};
    var bildu = {"label": "Bildu", "id": 9, "value": 0, "color": "#b0d136"};
    var mp = {"label": "Compromis", "id": 10, "value": 0, "color": "#d74c27"};
    var cup = {"label": "CUP", "id": 11, "value": 0, "color": "#ffeea7"};
    var cc = {"label": "Coalición Canaria", "id": 12, "value": 0, "color": "#ffed00"};
    var upn = {"label": "UPN", "id": 13, "value": 0, "color": "#0065a7"};
    var bng = {"label": "Bloque Nacionalista Gallego", "id": 14, "value": 0, "color": "#16375e"};
    var prc = {"label": "Partido Regionalista de Cantabria", "id": 15, "value": 0, "color": "#16375e"};
    var te = {"label": "Teruel Existe", "id": 16, "value": 0, "color": "#16375e"};
    var gobierno = {"label": "Gobierno", "id": 17, "value": 0, "color": "#000"};
    laws.forEach( (law) => {
